...
#endif
#if defined(MOZJS_MAJOR_VERSION)
bool js_PluginSdkboxPlayJS_PluginSdkboxPlay_fetchGameDataNames(JSContext *cx, uint32_t argc, JS::Value *vp)
{
    JS::CallArgs args = JS::CallArgsFromVp(argc, vp);
    if (argc == 0) {
    ...
    JS_ReportErrorUTF8(cx, "js_PluginSdkboxPlayJS_PluginSdkboxPlay_fetchGameDataNames : wrong number of arguments");
    return false;
}
#elif defined(JS_VERSION)
JSBool js_PluginSdkboxPlayJS_PluginSdkboxPlay_fetchGameDataNames(JSContext *cx, uint32_t argc, jsval *vp)
{
    if (argc == 0) {
        sdkbox::PluginSdkboxPlay::fetchGameDataNames();
        JS_SET_RVAL(cx, vp, JSVAL_VOID);
...
#endif
#if defined(MOZJS_MAJOR_VERSION)
bool js_PluginSdkboxPlayJS_PluginSdkboxPlay_loadOneGameData(JSContext *cx, uint32_t argc, JS::Value *vp)
{
    JS::CallArgs args = JS::CallArgsFromVp(argc, vp);
    bool ok = true;
    if (argc == 1) {
        std::string arg0;
        ok &= jsval_to_std_string(cx, args.get(0), &arg0);
        JSB_PRECONDITION2(ok, cx, false, "js_PluginSdkboxPlayJS_PluginSdkboxPlay_loadOneGameData : Error processing arguments");
        sdkbox::PluginSdkboxPlay::loadOneGameData(arg0);
        args.rval().setUndefined();
        return true;
    }
    JS_ReportErrorUTF8(cx, "js_PluginSdkboxPlayJS_PluginSdkboxPlay_loadOneGameData : wrong number of arguments");
    return false;
}
#elif defined(JS_VERSION)
JSBool js_PluginSdkboxPlayJS_PluginSdkboxPlay_loadOneGameData(JSContext *cx, uint32_t argc, jsval *vp)
{
    jsval *argv = JS_ARGV(cx, vp);
    JSBool ok = JS_TRUE;
    if (argc == 1) {
...
#endif
#if defined(MOZJS_MAJOR_VERSION)
bool js_PluginSdkboxPlayJS_PluginSdkboxPlay_setGDPR(JSContext *cx, uint32_t argc, JS::Value *vp)
{
    JS::CallArgs args = JS::CallArgsFromVp(argc, vp);
    bool ok = true;
    if (argc == 1) {
        ...
        JSB_PRECONDITION2(ok, cx, false, "js_PluginSdkboxPlayJS_PluginSdkboxPlay_setGDPR : Error processing arguments");
        sdkbox::PluginSdkboxPlay::setGDPR(arg0);
        args.rval().setUndefined();
        return true;
    }
    JS_ReportErrorUTF8(cx, "js_PluginSdkboxPlayJS_PluginSdkboxPlay_setGDPR : wrong number of arguments");
    return false;
}
#elif defined(JS_VERSION)
JSBool js_PluginSdkboxPlayJS_PluginSdkboxPlay_setGDPR(JSContext *cx, uint32_t argc, jsval *vp)
{
    jsval *argv = JS_ARGV(cx, vp);
    JSBool ok = JS_TRUE;
    if (argc == 1) {
...
#endif
#if defined(MOZJS_MAJOR_VERSION)
bool js_PluginSdkboxPlayJS_PluginSdkboxPlay_generateIdentityVerificationSignature(JSContext *cx, uint32_t argc, JS::Value *vp)
{
    JS::CallArgs args = JS::CallArgsFromVp(argc, vp);
    if (argc == 0) {
    ...
    JS_ReportErrorUTF8(cx, "js_PluginSdkboxPlayJS_PluginSdkboxPlay_generateIdentityVerificationSignature : wrong number of arguments");
    return false;
}
#elif defined(JS_VERSION)
JSBool js_PluginSdkboxPlayJS_PluginSdkboxPlay_generateIdentityVerificationSignature(JSContext *cx, uint32_t argc, jsval *vp)
{
    if (argc == 0) {
        sdkbox::PluginSdkboxPlay::generateIdentityVerificationSignature();
        JS_SET_RVAL(cx, vp, JSVAL_VOID);
...
bool js_PluginSdkboxPlayJS_PluginSdkboxPlay_signin(JSContext *cx, uint32_t argc, JS::Value *vp)
{
    ...
    if (argc == 1) {
        bool arg0;
        ok &= sdkbox::js_to_bool(cx, args.get(0), (bool *)&arg0);
        JSB_PRECONDITION2(ok, cx, false, "js_PluginSdkboxPlayJS_PluginSdkboxPlay_signin : Error processing arguments");
...
void js_register_PluginSdkboxPlayJS_PluginSdkboxPlay(JSContext *cx, JS::HandleObject global) {
...
#else
    static JSClass PluginSdkboxPlay_class = {
        "PluginSdkboxPlay",
        JSCLASS_HAS_PRIVATE,
        nullptr
    };
    jsb_sdkbox_PluginSdkboxPlay_class = &PluginSdkboxPlay_class;
#endif
    ...
    static JSFunctionSpec st_funcs[] = {
        ...
        JS_FN("fetchGameDataNames", js_PluginSdkboxPlayJS_PluginSdkboxPlay_fetchGameDataNames, 0, JSPROP_PERMANENT | JSPROP_ENUMERATE),
        ...
        JS_FN("loadOneGameData", js_PluginSdkboxPlayJS_PluginSdkboxPlay_loadOneGameData, 1, JSPROP_PERMANENT | JSPROP_ENUMERATE),
        JS_FN("setGDPR", js_PluginSdkboxPlayJS_PluginSdkboxPlay_setGDPR, 1, JSPROP_PERMANENT | JSPROP_ENUMERATE),
        JS_FN("loadAchievements", js_PluginSdkboxPlayJS_PluginSdkboxPlay_loadAchievements, 1, JSPROP_PERMANENT | JSPROP_ENUMERATE),
        JS_FN("generateIdentityVerificationSignature", js_PluginSdkboxPlayJS_PluginSdkboxPlay_generateIdentityVerificationSignature, 0, JSPROP_PERMANENT | JSPROP_ENUMERATE),
